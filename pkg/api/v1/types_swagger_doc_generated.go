...
var map_ObjectMeta = map[string]string{
	"":                           "ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create. DEPRECATED: Use github.com/lavalamp/client-go-flat/apimachinery/pkg/apis/meta/v1.ObjectMeta instead - this type will be removed soon.",

...
type OwnerReference struct {
	...
	// UID of the referent.
	// More info: http://kubernetes.io/docs/user-guide/identifiers#uids
	UID types.UID `json:"uid" protobuf:"bytes,4,opt,name=uid,casttype=github.com/lavalamp/client-go-flat/apimachinery/pkg/types.UID"`
...
type Preconditions struct {
	...
	// +optional
	UID *types.UID `json:"uid,omitempty" protobuf:"bytes,1,opt,name=uid,casttype=github.com/lavalamp/client-go-flat/apimachinery/pkg/types.UID"`
}
